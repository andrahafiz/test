...
<head>
    ...
    <title>Perusahaan Gas Negara | Login RW</title>
    <!-- Google font-->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="login-card">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-4"><a class="btn btn-primary btn-block"
                                        href="{{ route('warga.login') }}">Warga</a></div>
                                <div class="col-4"><a class="btn btn-light active txt-dark disabled"
                                        href="">RW</a></div>
                                <div class="col-4"><a class="btn btn-primary btn-block"
                                        href="{{ route('rt.login') }}">RT</a></div>
                            </div>
                        </div>
                    </div>
                </div>
